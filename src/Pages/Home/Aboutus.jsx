...
import logoVideo from "../../../public/images/a1.png";
import logoVideo2 from "../../../public/images/a2.png";
import logoVideo3 from "../../../public/images/a3.jpeg";
import logoVideo4 from "../../../public/images/a4.jpeg";
  ...
  return (
    <div className="dark:bg-semi">
      ...
      <div className="relative">
        ...
        {/* Title Overlay */}
        <h1
          className="absolute top-1/2 px-9 transform -translate-x-1/2 -translate-y-1/2 text-semi text-start text-7xl"
          data-aos="fade-left"
        >
          About us
        </h1>
            ...
            <div className="order-2 sm:order-1 space-y-6 sm:pr-32">
              <div>
                ...
                >
                  ...
                  efficient, and affordable taxi service for the people of
                  Bhopal and its visitors. Over the years, we have dedicated
                  ourselves to providing top-notch taxi services that ensure
            ...
            <div className="order-1 sm:order-2 space-x-6 sm:pl-32 ">
              <div>
                ...
                >
                  ...
                  <br />
                  At Baba Mahakal Tour and Travels, our mission is to provide
                  our customers with safe, convenient, and reliable
                  transportation solutions that enhance their travel
                  experiences. We are committed to delivering exceptional car
                  rental services in Bhopal and beyond, offering a diverse fleet
                  of well-maintained vehicles and a dedicated team of
                  professionals to ensure our clients’ comfort, convenience, and
                  satisfaction. We strive to be a trusted partner for all your
                  travel needs, making every journey memorable and hassle-free.
                  <br />
                  <span className="text-2xl text-semi dark:text-white">
                    Vission
                  </span>
                  <br />
                  Our vision at Baba Mahakal Tour and Travels is to be the
                  premier car rental service in Bhopal, setting the industry
                  standard for excellence and customer satisfaction. We aim to
                  continually expand our fleet, services, and reach to serve
                  more travelers and businesses across the region. We aspire to
                  innovate and adopt eco-friendly practices to contribute to a
                  sustainable future. Our vision is to build enduring
                  relationships with our clients, partners, and communities,
                  becoming the go-to choice for those seeking exceptional car
                  rental experiences in Bhopal and beyond.
                </h3>
              </div>
            </div>
          </div>
      ...
      <div className="dark:bg-semi_primary dark:text-white duration-300 relative z-20 mt-6">
        <div className="container min-h-[420px] flex">
          <div className="grid place-items-center grid-cols-1 sm:grid-cols-2">
            ...
            {/* Text Section */}
            <div className="order-2 sm:order-1 space-x-6 sm:pl-32 ">
              <div>
                <h1
                  className="text-2xl lg:text-2xl font-semibold font-serif"
                  data-aos="fade-up"
                ...
                >
                  ...
                  clicks, you can secure your ride, choose your vehicle, and
                  even track your driver’s location in real-time. We put the
                  power of transportation in your hands.
                </h3>
              </div>
            </div>
          </div>
